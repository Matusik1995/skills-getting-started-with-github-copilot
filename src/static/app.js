            ...
            ${details.participants.length > 0
              ? `<ul>${details.participants.map((participant) => `
                  <li>
                    ...
                    <button type="button" class="remove-participant" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(participant)}" aria-label="Remove ${participant}" title="Remove participant">&times;</button>
                  </li>`).join("")}</ul>`
